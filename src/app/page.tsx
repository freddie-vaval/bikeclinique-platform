...
const PRICING_PLANS = [
  {
    name: 'Starter',
    price: '£39',
    desc: 'For solo mechanics running their own shop.',
    features: ['1 mechanic', 'Unlimited jobs', 'AI phone assistant', 'SMS & WhatsApp updates', 'Stripe payments', 'Delivery scheduling', 'AI diagnosis assistant', 'AI job summaries'],
  ...
  },
  {
    name: 'Pro',
    price: '£59',
    desc: 'For shops with 2 or more mechanics.',
    features: ['Up to 3 mechanics', 'Everything in Starter', 'Team management', 'Advanced reporting', 'Customer analytics', 'Priority support', 'Custom branding'],
    cta: 'Start Free Trial',
    popular: true,
  },
  {
    ...
    features: ['Unlimited locations', 'Everything in Pro', 'White-label app', 'API access', 'Dedicated account manager', 'Custom integrations', ' Franchise tools'],
    cta: 'Contact Sales',
    popular: false,
  },
];
